...
\item \textbf{[A] Atomic-path soundness.} Close the unguarded
  ...
  tests.)}
\item \textbf{[A] Dynamic-gate promotion.} Promote the stable Miri and
...
\item \textbf{[B/C] Repository seeds (scaffolded).} Initialize the
