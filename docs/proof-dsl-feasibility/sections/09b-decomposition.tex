...
\item \textbf{[B] \code{ves-vocabulary}. \textbf{Done}
  ...
  in lane B.)}
  Landed 77 constructors across 16 namespaces with trust-class and
  invariant-family annotations, dependency-resolution and structural
  ...
  statement hashes. 17 tests, all passing. WP-6 (\code{ves-tokens}) is
  next; lane C's WP-13 is unblocked in principle, since its only
  cross-lane dependency (this item) has landed.
...
may begin while lane B continues 6$\to$8 --- and is otherwise
