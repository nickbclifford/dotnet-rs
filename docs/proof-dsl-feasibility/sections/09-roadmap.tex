...
\begin{description}
\item[Phase 0 --- Hygiene (days).] Fix the two live defects
  ...
  raises the floor the DSL builds on.
\item[Phase 1 --- The embedded layer (4--7 weeks).] In order:
  in \path{ves-proof/crates/}, \code{ves-syntax} and the declarative
  vocabulary v0 (the F1--F9
  constructors and their trust classes) with its two code generators;
