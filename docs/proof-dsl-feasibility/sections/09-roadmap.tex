...
\item[Phase 1 --- The embedded layer (4--7 weeks).] \textbf{In
  ...
  contract-layer package); \code{ves-check} in structural mode (empty
  proof manifest, everything trusted or unproved); scripts
  ...
  than a model. Four of the five crates are in; \code{ves-check} is
