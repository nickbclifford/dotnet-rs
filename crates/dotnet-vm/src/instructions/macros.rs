...
macro_rules! binary_op {
    ($(#[$attr:meta])* $func_name:ident, $op:tt) => {
        $(#[$attr])*
        pub fn $func_name<'gc, T: $crate::stack::ops::EvalStackOps<'gc>>(
            ctx: &mut T,
        ) -> StepResult {
            #[allow(unused_imports)]
            use $crate::stack::ops::EvalStackOps;
...
macro_rules! binary_op_result {
    ($(#[$attr:meta])* $func_name:ident, $method:ident) => {
        $(#[$attr])*
        pub fn $func_name<'gc, T: $crate::stack::ops::EvalStackOps<'gc> + $crate::stack::ops::ExceptionOps<'gc>>(
            ctx: &mut T,
            sgn: NumberSign,
        ) -> StepResult {
            #[allow(unused_imports)]
...
macro_rules! comparison_op {
    ($(#[$attr:meta])* $func_name:ident, $pat:pat) => {
        $(#[$attr])*
        pub fn $func_name<'gc, T: $crate::stack::ops::EvalStackOps<'gc> + $crate::stack::ops::TypedStackOps<'gc>>(
            ctx: &mut T,
            sgn: NumberSign,
        ) -> StepResult {
            #[allow(unused_imports)]
...
macro_rules! load_var {
    ($(#[$attr:meta])* $func_name:ident, $get_method:ident, $index_type:ident) => {
        $(#[$attr])*
        pub fn $func_name<'gc, T: $crate::stack::ops::VariableOps<'gc> + $crate::stack::ops::EvalStackOps<'gc>>(
            ctx: &mut T,
            index: u16,
        ) -> StepResult {
            #[allow(unused_imports)]
