...
pub fn intrinsic_type_get_type<'gc, T: TypedStackOps<'gc> + LoaderOps + ReflectionOps<'gc>>(
    ctx: &mut T,
...
pub fn runtime_type_intrinsic_call<
    'gc,
    T: EvalStackOps<'gc>
        + TypedStackOps<'gc>
        + LoaderOps
...
pub fn runtime_type_handle_intrinsic_call<
    'gc,
    T: EvalStackOps<'gc> + TypedStackOps<'gc> + LoaderOps + ReflectionOps<'gc> + RawMemoryOps<'gc>,
>(
    ctx: &mut T,
    method: MethodDescription,
    _generics: &GenericLookup,
...
pub fn intrinsic_runtime_helpers_is_bitwise_equatable<
    'gc,
    T: TypedStackOps<'gc> + ResolutionOps<'gc>,
>(
    ctx: &mut T,
    _method: MethodDescription,
    generics: &GenericLookup,
