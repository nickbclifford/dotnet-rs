...
//!     ) -> StepResult { ... }
//!     ```
//!     Place VM-local handlers in the appropriate submodule (for example,
//!     `src/intrinsics/object_ops.rs`) or in the responsible `dotnet-intrinsics-*` crate.
//!
...
//! ```
use crate::{error::ExecutionError, stack::ops::VesOps};
